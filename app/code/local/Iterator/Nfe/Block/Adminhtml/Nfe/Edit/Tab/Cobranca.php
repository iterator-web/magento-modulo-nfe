...
class Iterator_Nfe_Block_Adminhtml_Nfe_Edit_Tab_Cobranca extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset = $form->addFieldset('base_fieldset', array(
            'legend'    => utf8_encode('Informações da Cobrança'),
            'class'     => 'fieldset',
        ));
        
        $fieldset->addField('cob_n_fat', 'text', array(
            'name'      => 'cob_n_fat',
            'label'     => utf8_encode('Número da Fatura'),
            'title'     => utf8_encode('Número da Fatura'),
            'required'  => false,
        ));
        ...
        $fieldset->addField('cob_v_liq', 'text', array(
            'name'      => 'cob_v_liq',
            'label'     => utf8_encode('Valor Líquido'),
            'title'     => utf8_encode('Valor Líquido'),
            'required'  => false,
        ));
