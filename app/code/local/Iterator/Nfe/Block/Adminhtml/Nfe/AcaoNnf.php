...
class Iterator_Nfe_Block_Adminhtml_Nfe_AcaoNnf extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row) {
        ...
        return '<a href="javascript:carregarNfe(\''.$adminUrl.'\', \''.$skinUrl.'\', \''.$nfeId.'\', \''.$nNf.'\')">'.$nNf.'</a>';
    }
}
?>
