    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('nat_op', 'select', array(
            ...
            'values'    => array(
               ...
               array('value' => utf8_encode('Remessa de merc. por conta ordem terc., em venda р ordem'), 'label' => utf8_encode('Remessa de merc. por conta ordem terc., em venda р ordem')),
               array('value' => utf8_encode('Remessa em Consignaчуo'), 'label' => utf8_encode('Remessa em Consignaчуo')),
            ),
        ));
