...
class Iterator_Nfe_Block_Adminhtml_Nfe_AcaoTipo extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
   
    public function render(Varien_Object $row) {
        $status =  $row->getData('tp_nf');
        $descricao = null;
        switch($status) {
            case 0:
                $descricao = 'Entrada';
