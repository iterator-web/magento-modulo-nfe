...
class Iterator_Nfe_Block_Adminhtml_Nfe_Report extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct() {
        ...
        $this->_controller = 'adminhtml_nfe_report';
        
        $this->_removeButton('save');
        
        $this->_addButton('gerarreport', array(
            'label'     => Mage::helper('adminhtml')->__(utf8_encode('Gerar Relatório de Nota Fiscal Eletrônica (NF-e)')),
            'onclick'   => 'gerarReport()',
            'class'     => 'save',
        ), -100);
        ...
        $this->_formScripts[] = '
            function gerarReport(){
                editForm.submit();
                window.open("'.Mage::helper('adminhtml')->getUrl('*/nfe/abrirRelatorio/').'", "_blank");
            }
        ';
    }  
 
    public function getHeaderText() {
        return Mage::helper('nfe')->__(utf8_encode('Gerar Novo Relatório de Nota Fiscal Eletrônica (NF-e)'));
    }
}
