...
class Iterator_Nfe_Block_Adminhtml_Nfe_Enviar extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct() {
        ...
        $this->_controller = 'adminhtml_nfe_enviar';
        
        $this->_updateButton('save', 'label', $this->__(utf8_encode('Enviar')));
    }  
 
    public function getHeaderText() {
        return Mage::helper('nfe')->__(utf8_encode('Enviar NF-e do Mês'));
    }  
}