...
class Iterator_Nfe_Block_Adminhtml_Nfe_Edit_Form extends Mage_Adminhtml_Block_Widget_Form { 
    ...
    protected function _prepareForm() {  
        ...
        $form = new Varien_Data_Form(array(
            'id'        => 'edit_form',
            'action'    => $this->getUrl('*/*/save', array('nfe_id' => $this->getRequest()->getParam('nfe_id'))),
            'method'    => 'post'
        ));
