...
class Iterator_Nfe_Block_Adminhtml_Nfe_Edit_Tab_Entrega extends Mage_Adminhtml_Block_Widget_Form {

    protected function _prepareForm() {
        $model = Mage::registry('nfe_entrega');
     
        $form = new Varien_Data_Form();
        $form->setHtmlIdPrefix('entrega_');
        $form->setFieldNameSuffix('entrega');
     
        $fieldset = $form->addFieldset('base_fieldset', array(
            'legend'    => utf8_encode('Informações do Local de Entrega'),
            'class'     => 'fieldset',
        ));
        ...
        $fieldsetEndereco = $form->addFieldset('base_fieldset_endereco', array(
            'legend'    => utf8_encode('Endereço do Local de Entrega'),
            'class'     => 'fieldset',
        ));
        ...
        $municipio->setRenderer(
            $this->getLayout()->createBlock('nfe/adminhtml_nfe_edit_tab_renderer_municipioentrega')
        );
