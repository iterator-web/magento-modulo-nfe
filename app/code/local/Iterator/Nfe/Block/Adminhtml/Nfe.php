...
class Iterator_Nfe_Block_Adminhtml_Nfe extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        $this->_blockGroup = 'nfe';
        $this->_controller = 'adminhtml_nfe';
        $this->_headerText = $this->__('Gerenciar NF-e');       
         
        parent::__construct();
        $this->_updateButton('add', 'label', $this->__('Criar NF-e'));
    }
}
?>
