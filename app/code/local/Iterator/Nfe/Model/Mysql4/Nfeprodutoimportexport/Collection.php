...
class Iterator_Nfe_Model_Mysql4_NfeProdutoImportexport_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {

    protected function _construct() {
        $this->_init('nfe/nfeprodutoimportexport');
    }
}
