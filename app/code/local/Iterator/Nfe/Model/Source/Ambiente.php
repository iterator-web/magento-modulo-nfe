...
class Iterator_Nfe_Model_Source_Ambiente {
    
    public function toOptionArray() {
        return array(
            array('value' => 'homologacao', 'label' => utf8_encode('Ambiente de Homologação')),
            array('value' => 'producao', 'label' => utf8_encode('Ambiente de Produção')),
        );
    }
}
