...
class Iterator_Nfe_Model_Source_Horario {
    
    public function toOptionArray() {
        return array(
            array('value' => '-03:00', 'label' => utf8_encode('Horário Padrão (-03:00)')),
            array('value' => '-02:00', 'label' => utf8_encode('Horário de Verão (-02:00)')),
        );
    }
}
