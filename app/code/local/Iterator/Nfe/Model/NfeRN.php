...
class Iterator_Nfe_Model_NfeRN extends Mage_Core_Model_Abstract {
    ...
    private function preencherCampos($nfe, $nfeCriarXML) {
        ...
        $dhEmi = str_replace(' ', 'T', $dhEmi).'-03:00';  //para verṣo 3.00 '2014-02-03T13:22:42-3.00' ṇo informar para NFCe
        $dhSaiEnt = $validarCampos->getHoraCerta($nfe->getDhSaiEnt());
        $dhSaiEnt = str_replace(' ', 'T', $dhSaiEnt).'-03:00'; //verṣo 2.00, 3.00 e 3.10
        $tpNF = $nfe->getTpNf();
